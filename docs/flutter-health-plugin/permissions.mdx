...
<CardGroup cols={2}>
  <Card title="Health Connect" icon="android" href="/flutter-health-plugin/health-connect">
    Android-specific Health Connect features
  </Card>
  <Card title="Platform Setup" icon="mobile" href="/flutter-health-plugin/platform-android">
