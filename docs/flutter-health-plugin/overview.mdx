...
<Steps>
  <Step title="Setup Your Project">
    ...
    [Go to Installation →](/flutter-health-plugin/install)
  </Step>
  
  <Step title="Request Permissions">
    Ask users for permission to access specific health data types
    
    [Learn about Permissions →](/flutter-health-plugin/permissions)
  </Step>
  
  <Step title="Read or Write Data">
    Use the Health API to read existing data or write new measurements
    
    [Reading Guide →](/flutter-health-plugin/read-overview) | [Writing Guide →](/flutter-health-plugin/write-overview)
  </Step>
</Steps>
...
<Card title="Try the Full Example" icon="play" href="/flutter-health-plugin/quickstart">
...
[See all data types →](/flutter-health-plugin/data-types)
...
<CardGroup cols={2}>
  <Card title="Android Setup" icon="android" href="/flutter-health-plugin/platform-android">
    Configure Health Connect permissions and manifest settings
  </Card>
  <Card title="iOS Setup" icon="apple" href="/flutter-health-plugin/platform-ios">
...
<CardGroup cols={2}>
  <Card title="Installation" icon="download" href="/flutter-health-plugin/install">
    Add the plugin to your Flutter project
  </Card>
  <Card title="Quickstart" icon="bolt" href="/flutter-health-plugin/quickstart">
    Get up and running in 5 minutes
  </Card>
  <Card title="Core Concepts" icon="lightbulb" href="/flutter-health-plugin/permissions">
    Understand permissions and data types
  </Card>
  <Card title="API Reference" icon="code" href="/flutter-health-plugin/api-health-class">
