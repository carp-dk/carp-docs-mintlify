---
title: "Data Types & Units"
description: Types are defined in the `HealthDataType` enum with a default `HealthDataUnit` per type.
---
...
- [Basic Reading](basic) - Reading health data
- [Basic Writing](basic) - Writing health data
