...
Write cardiovascular health data using specialized methods.

## Blood Pressure

Write systolic and diastolic readings together using `writeBloodPressure`.
...
- [Basic Reading](read-basic) - Reading cardiovascular data
