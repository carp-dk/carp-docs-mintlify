---
title: "Health Class API"
description: Complete reference for the `Health` class - the main interface for health data operations.
---
...
[See Workout Writing docs](write/specialized)
