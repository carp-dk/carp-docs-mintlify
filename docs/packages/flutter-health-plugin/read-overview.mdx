...
The Health plugin provides multiple methods for reading health data with different levels of granularity and aggregation.
...
**See:** [Interval Reading](read-interval)
...
**See:** [Aggregate Reading](read-aggregate)
...
- **[Basic Reading](read-basic)** - Individual data points with full details
- **[Interval Reading](read-interval)** - Time-bucketed aggregations
- **[Aggregate Reading](read-aggregate)** - Multi-type summaries
- **[Reading Steps](read-steps)** - Optimized step count queries
