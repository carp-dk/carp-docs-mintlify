...
description: Fetch pre-aggregated health data summaries across multiple types using `getHealthAggregateDataFromTypes`.
---
...
- [Writing Workouts](specialized) - Creating workout data
