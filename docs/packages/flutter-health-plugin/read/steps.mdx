---
title: "Steps"
description: "Get total step count for a time period using `getTotalStepsInInterval`."
---
```dart
...
- [Basic Reading](basic) - Read individual step samples
- [Interval Reading](interval) - Steps grouped by hour/day
