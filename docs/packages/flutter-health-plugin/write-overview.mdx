...
Write health and fitness data to the platform's health store (iOS HealthKit / Android Health Connect).
...
- [Basic Writing](write-basic) - Numeric health data
- [Writing Workouts](write-workouts) - Exercise sessions
- [Blood Pressure & Oxygen](write-blood) - Cardiovascular metrics
- [Nutrition](write-nutrition) - Meal tracking
- [Specialized Types](write-specialized) - Audiograms, insulin, menstruation
