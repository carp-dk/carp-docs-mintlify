---
title: Specialized Data Types
description: Write specialized health data including menstruation, audiograms, and insulin delivery.
---
...
- [Basic Reading](basic) - Reading specialized data
