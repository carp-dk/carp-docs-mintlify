---
title: Workouts
description: Write exercise sessions using `writeWorkoutData`.
---
...
- [Aggregate Reading](aggregate) - Read workout summaries
- [Basic Writing](basic) - Write simple numeric data
