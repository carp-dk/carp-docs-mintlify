...
Each transformer schema must be registered in the [`DataTransformerSchemaRegistry`](https://pub.dev/documentation/carp_mobile_sensing/latest/domain/DataTransformerSchemaRegistry-class.html) (which is a singleton).
Hence, add the following line to your setup up part of the app:

````dart
DataTransformerSchemaRegistry().register(OMHTransformerSchema());
````
...
2. Register this function in the [`DataTransformerSchemaRegistry`](https://pub.dev/documentation/carp_mobile_sensing/latest/domain/DataTransformerSchemaRegistry-class.html) as part of the default `PrivacySchema.DEFAULT` schema.
