...
<Tip>
CAMS support **persistent sampling**. This implies that once a study is defined (via a protocol), added and deployed on a client, and resumed, its entire state is persistently saved across app restart.
