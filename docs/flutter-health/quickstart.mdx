...
<CardGroup cols={2}>
  ...
  <Card title="Platform Setup" icon="mobile" href="/flutter-health/install">
...
<CardGroup cols={2}>
  ...
  <Card title="Writing Data" icon="pen-to-square" href="/flutter-health/write-overview">
    Explore writing workouts, meals, and specialized data
  </Card>
  <Card title="Permissions" icon="lock" href="/flutter-health/permissions">
